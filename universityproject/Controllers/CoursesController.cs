...
namespace ContosoUniversity.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(SchoolContext context, InterfaceUnitOfWork unitOfWork,ICourseRepository courseRepository)
        {
            _context = context;
        ...
        {
            List<Course> schoolContext = await _courseRepository.getRelatedDepartment();
        ...
        {
            var departmentsQuery = from d in _unitOfWork.getDepartmentRepository.GetAll()
                                   orderby d.Name
                                   select d;
        ...
        public async Task<IActionResult> Create([Bind("CourseID,Credits,DepartmentID,Title")] Course course)
        {
            ...
            {
                _unitOfWork.getCourseRepository.Insert(course);
